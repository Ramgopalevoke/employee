...
class EmployeeServiceUnitTests extends EmployeeApplicationTests {
    ...
    public void getAllEmployeesTest() throws Exception {
        ...
        dep.setDepId(1);
        list.add(new Employee("Ram", "kumar", "ram@evoketechnologies.com", "0000000000", new Date(), 1, dep));
        list.add(new Employee("gopal", "krishna", "gopal@evoketechnologies.com", "1111111111", new Date(), 1, dep));
        dep.setDepId(2);
        list.add(new Employee("sree", "nivas", "sree@evoketechnologies.com", "2222222222", new Date(), 2, dep));
        dep.setDepId(3);
        list.add(new Employee("vishnu", "varma", "vishnu@evoketechnologies.com", "3333333333", new Date(), 3, dep));
    ...
    public void getEmployeeByIdTest() {
        Department dep = new Department();
        dep.setDepId(1);
        Employee empTest = new Employee("ram", "kumar", "ram@evoketechnologies.com", "0000000000", new Date(), 1, dep);
    ...
    public void createEmployeeTest() {
        Department dep = new Department();
        dep.setDepId(1);
        Employee emp = new Employee("Ram", "kumar", "ram@evoketechnologies.com", "0000000000", new Date(), 1, dep);
    ...
    public void updateEmployeeTest() {
        Department dep = new Department();
        dep.setDepId(1);
        Employee emp = new Employee("RamUpdated", "kumarUpdated", "ram@evoketechnologies.com", "0000000000", new Date(), 1, dep);
